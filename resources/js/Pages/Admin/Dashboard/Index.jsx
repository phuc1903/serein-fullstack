function Dashboard() {
    return (  
        <>
            <nav
    className="w-100 layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme"
    id="layout-navbar"
    >
    ...
    >
        ...
        <li className="nav-item dropdown-shortcuts navbar-dropdown dropdown me-2 me-xl-0">
            ...
            <div className="dropdown-menu-header border-bottom">
                ...
                <h5 className="text-body mb-0 me-auto">Tiện ích</h5>
                </div>
            </div>
            <div className="dropdown-shortcuts-list scrollable-container">
                <div className="row row-bordered overflow-visible g-0">
                <div className="dropdown-shortcuts-item col custom-utilities-dashboard">
                    ...
                    <small className="text-muted mb-0">12 sản phẩm</small>
                </div>
                <div className="dropdown-shortcuts-item col custom-utilities-dashboard">
                    <span className="dropdown-shortcuts-icon rounded-circle mb-2">
                    ...
                    <small className="text-muted mb-0">12 hóa đơn</small>
                </div>
                </div>
                <div className="row row-bordered overflow-visible g-0">
                <div className="dropdown-shortcuts-item col custom-utilities-dashboard">
